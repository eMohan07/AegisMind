...
class LinearConnector(ConnectorPort):
    """Linear organizations, teams, projects, and issues."""
    ...
    def __init__(
        ...
        default_fixture = base_dir / "fixtures" / "linear_sample.json"
    ...
    def spec(self) -> ConnectorSpec:
        return ConnectorSpec(
            name="linear",
            version="0.0.1",
            description="Linear organizations, teams, projects, and issues",
            config_schema={
                "type": "object",
                "properties": {
                    "api_key": {"type": "string"},
    ...
    async def read(
        ...
        for item in items:
            ...
            allowed = []
            if item.get("team_id"):
                allowed.append(f"team:{item['team_id']}")
