...
from aegismind_connector_teams import TeamsConnector, get_connector


@pytest.mark.asyncio
async def test_teams_conformance() -> None:
    connector = get_connector()
    await assert_conforms(connector, sample_state={"last_updated_at": "2026-09-01T00:00:00Z"})


@pytest.mark.asyncio
async def test_teams_acl_extraction() -> None:
